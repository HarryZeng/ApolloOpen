...
extern void raw_data_process(void);
//DCMI初始化
void DCMI_Init(void)
{
...
{ 
    ...
    DMADMCI_Handler.Init.PeriphInc=DMA_PINC_DISABLE;                //外设非增量模式 ok
    ...
    DMADMCI_Handler.Init.FIFOThreshold=DMA_FIFO_THRESHOLD_FULL; //使用1/2的FIFO 
